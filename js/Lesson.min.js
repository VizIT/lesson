...
(function(f){f.LessonBuilder=function(){this.init=function(){var c,g,d;g=document.getElementsByClassName("lessonElement");for(var e=g.length;e--;)c=g[e],c.hasAttribute("data-type")&&(d=c.getAttribute("data-type").toLowerCase(),"rangedsource"===d?new f.RangedSource(c):"setter"===d&&new f.Setter(c))};this.initWhenReady=function(){"interactive"===document.readyState||"complete"===document.readyState?this.init():document.addEventListener("DOMContentLoaded",this.init,!1)}};(new f.LessonBuilder).initWhenReady()})(window.vizit.lesson);
