...
(function (ns)
 {
   /**
    * Adaptor to map a field(r) to field(x,y,z) along a
    * radius vector originating (x0, y0, z0) and extending
    * in the theta_, phi_ dirdction.
    *
    ...
    * @class
    */
   ns.DotRAdapter = function(source_, x0_, y0_, z0_, theta_, phi_)
   {
     var source;
